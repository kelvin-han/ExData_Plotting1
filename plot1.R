...
## Generate Histogram and save in png format
png('plot1.png')
hist(subSetData$Global_active_power, ylim=c(0,1200),col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
dev.off()
